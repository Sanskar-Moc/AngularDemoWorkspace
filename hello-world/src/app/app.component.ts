...
// this is the page all the components will be rendered in.
...
// app : contains the angular2 app
// app.module.ts: Application components bootstrapped here
// app.component.ts : Contains root component of the application
// app.component.html: Contains html template
// e2e : contains components for end to end testing
// style.css : stores application level styles
// package.json : Contains npm package dependencies for the project listed.
